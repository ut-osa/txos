...
static int dev_seq_open(struct _inode *inode, struct file *file)
{
...
static int softnet_seq_open(struct _inode *inode, struct file *file)
{
...
static int ptype_seq_open(struct _inode *inode, struct file *file)
{
