...
static int sockstat_seq_open(struct _inode *inode, struct file *file)
{
...
static int snmp_seq_open(struct _inode *inode, struct file *file)
{
...
static int netstat_seq_open(struct _inode *inode, struct file *file)
{
