...
#define NFS_SB(s)		((struct nfs_server *)(tx_cache_get_super(s)->s_fs_info))
...
static inline int nfs_server_capable(struct _inode *inode, int cap)
{
 ...
 */
extern struct tx_list_head nfs_automount_list;
