...
typedef int (*v4l2_kioctl)(struct _inode *inode, struct file *file,
			   unsigned int cmd, void *arg);
#ifdef CONFIG_VIDEO_V4L1_COMPAT
int v4l_compat_translate_ioctl(struct _inode *inode, struct file *file,
...
extern int video_ioctl2(struct _inode *inode, struct file *file,
...
extern int video_exclusive_open(struct _inode *inode, struct file *file);
extern int video_exclusive_release(struct _inode *inode, struct file *file);
#endif
