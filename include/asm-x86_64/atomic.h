...
#ifdef CONFIG_TX_KSTM
/* Store a checkpoint value in the shadow field and use it to
 * calculate a delta at commit time
 */

#define atomic_checkpoint(i) (((i)->shadow) = ((i)->counter))
#define atomic_delta(i) (((i)->counter) - ((i)->shadow))
...
#define atomic64_checkpoint(i) (((i)->shadow) = ((i)->counter))
#define atomic64_delta(i) (((i)->counter) - ((i)->shadow))
