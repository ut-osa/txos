...
static int acpi_thermal_state_open_fs(struct _inode *inode, struct file *file);
static int acpi_thermal_temp_open_fs(struct _inode *inode, struct file *file);
static int acpi_thermal_trip_open_fs(struct _inode *inode, struct file *file);
static int acpi_thermal_cooling_open_fs(struct _inode *inode, struct file *file);
static ssize_t acpi_thermal_write_cooling_mode(struct file *,
					       const char __user *, size_t,
					       loff_t *);
static int acpi_thermal_polling_open_fs(struct _inode *inode, struct file *file);
