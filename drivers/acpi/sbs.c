...
static int acpi_battery_info_open_fs(struct _inode *inode, struct file *file)
{
...
static int acpi_battery_state_open_fs(struct _inode *inode, struct file *file)
{
...
static int acpi_battery_alarm_open_fs(struct _inode *inode, struct file *file)
{
...
static int acpi_ac_state_open_fs(struct _inode *inode, struct file *file)
{
