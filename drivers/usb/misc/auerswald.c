...
static int auerchar_open (struct _inode *inode, struct file *file)
{
	...
	/* file IO stuff */
	tx_cache_get_file(file)->f_pos = 0;
...
static int auerchar_release (struct _inode *inode, struct file *file)
{
	pauerchar_t ccp = (pauerchar_t) file->private_data;
	pauerswald_t cp;
	dbg("release");
