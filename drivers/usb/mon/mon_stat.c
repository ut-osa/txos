...
static int mon_stat_open(struct _inode *inode, struct file *file)
{
	struct mon_bus *mbus;
	struct snap *sp;
...
static int mon_stat_release(struct _inode *inode, struct file *file)
{
	return 0;
}
