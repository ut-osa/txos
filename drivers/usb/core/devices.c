...
static int usb_device_open(struct _inode *inode, struct file *file)
{
        file->private_data = NULL;
        return 0;
}

static int usb_device_release(struct _inode *inode, struct file *file)
{
...
static loff_t usb_device_lseek(struct _file * file, loff_t offset, int orig)
{
	loff_t ret;
