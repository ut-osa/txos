			...
			size_t count, loff_t *ppos)
{
	...
	if (tx_cache_get_file_ro(file)->f_flags & O_NONBLOCK && !gen_rtc_irq_data)
		return -EAGAIN;
...
static int gen_rtc_open(struct _inode *inode, struct file *file)
{
...
static int gen_rtc_release(struct _inode *inode, struct file *file)
{
	/*
