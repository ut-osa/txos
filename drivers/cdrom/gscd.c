...
static int gscd_ioctl(struct inode *, struct file *, unsigned int,
		      unsigned long);
static int gscd_open(struct _inode *, struct file *);
static int gscd_release(struct _inode *, struct file *);
...
static int gscd_open(struct _inode *ip, struct file *fp)
{
	int st;
...
static int gscd_release(struct _inode *inode, struct file *file)
{
