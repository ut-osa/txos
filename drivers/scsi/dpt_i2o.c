...
static int adpt_open(struct _inode *inode, struct file *file)
{
	int minor;
	adpt_hba* pHba;
...
static int adpt_close(struct _inode *inode, struct file *file)
{
	int minor;
	adpt_hba* pHba;
	      ...
	      ulong arg)
{
	...
	minor = iminor(tx_cache_get_inode_ro(inode));
