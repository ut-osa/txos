...
static int  ch_open(struct _inode * inode, struct file * filp);
static int  ch_release(struct _inode * inode, struct file * filp);
...
static int
ch_release(struct _inode *inode, struct file *file)
{
...
static int
ch_open(struct _inode *inode, struct file *file)
{
	scsi_changer *tmp, *ch;
