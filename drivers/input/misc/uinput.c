...
static int uinput_open(struct _inode *inode, struct file *file)
{
...
static ssize_t uinput_read(struct file *file, char __user *buffer, size_t count, loff_t *ppos)
{
	...
	if (udev->head == udev->tail && (tx_cache_get_file_ro(file)->f_flags & O_NONBLOCK))
		return -EAGAIN;
...
static int uinput_release(struct _inode *inode, struct file *file)
{
	struct uinput_device *udev = file->private_data;
