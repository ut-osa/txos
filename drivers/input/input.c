...
static int input_proc_devices_open(struct _inode *inode, struct file *file)
{
...
static int input_proc_handlers_open(struct _inode *inode, struct file *file)
{
...
static int input_open_file(struct _inode *inode, struct file *file)
{
